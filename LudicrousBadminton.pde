...
PImage court, net, shuttle, racone, ractwo;
...
void setup() {
  ...
  shuttle = loadImage("shuttlecock.png");
  racone = loadImage("racket0.png");
  ractwo = loadImage("racket1.png"); 
...
// COMPUTER AI
  ...
  if (estimateone && abs(estimateone - Bpos) < 10 && abs(shuttX - Bpos) < 75 && shuttY > 220) {
    Bforehand = true;
